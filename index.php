...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<div class="section">
				<hr>
				<marquee behavior="" direction=""><b>Selamat Datang Di YoTech - Menjual Buku</b></marquee>
				<hr>
				<br>
			</div>
			<!-- <div class="left">
			...
			<div class="center">
				<?php
						$sql = "SELECT * FROM t_artikel order by harga asc";
						...
						while ($data = mysqli_fetch_array($res)) {
							if(strlen($data["isi"] >= 40)) {
								...
								$z = '....';
								$y = substr($data["penerbit"],0,320) .'<br><a href=detail.php?id='.$data["harga"].'><button class="btn-info">Baca Selengkapnya</button></a>';
					};
				?>
				<div class="box">
